...
$(LOG_DIR)/dynamodb-init.log: cluster/cloudformationdynamodb.json
	...
	$(AWS) cloudformation create-stack --stack-name db-wshi999 --template-body file://$< || true | tee $(LOG_DIR)/dynamodb-init.log
...
#
dynamodb-clean:
	$(AWS) cloudformation delete-stack --stack-name db-wshi999 || true | tee $(LOG_DIR)/dynamodb-clean.log
...
s3: $(LOG_DIR)/s3.repo.log cluster/s3.taml cluster/s3-sm.yaml cluster/s3-vs.yaml
